import { SmartContract, MapStorage, constant, Fixed, Address, Deploy, receive, Blockchain, Hash256 } from '@neo-one/smart-contract';


export class Token extends SmartContract {
    public readonly name = 'Hypecoin';
    public readonly symbol = 'HYPE';
